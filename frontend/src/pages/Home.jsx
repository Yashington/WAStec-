...
const Home = () => {
  ...
  const stats = [
    {
      id: 1,
      name: "Biogas Generated (L)",
      value: biogasOutput.toLocaleString(),
    },
    { id: 2, name: "CO₂ Saved (kg)", value: co2Saved.toLocaleString() },
    {
      id: 3,
      name: "Waste Diverted (kg)",
      value: wasteDiverted.toLocaleString(),
    },
    {
      id: 4,
      name: "Clean Energy (kWh)",
      value: Math.floor(biogasOutput / 1000).toLocaleString(),
    },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-xl text-gray-500 max-w-3xl">
                BARC-incubated startup pioneering biogas purification and waste
                ...
                <div className="absolute -bottom-4 -right-4 bg-white p-3 sm:p-4 rounded-lg shadow-lg">
                  <div className="text-center">
                    <div className="text-xl sm:text-2xl font-bold text-green-600">
                      {biogasOutput.toLocaleString()}
                    </div>
                    <div className="text-xs sm:text-sm text-gray-500">
                      Liters Generated Today
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-10">
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
              {stats.map((stat) => (
                <div
                  key={stat.id}
                  className="bg-gradient-to-br from-white to-green-50 p-6 rounded-xl shadow-md border border-green-100"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <div className="rounded-xl w-full h-48 sm:h-64 flex items-center justify-center">
                <img
                  src={graph1}
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="bg-gradient-to-br from-white to-green-50 p-6 rounded-xl shadow-md border border-green-100">
                ...
                <p className="mt-2 text-gray-500">
                  Advanced purification technology converting raw biogas into
                  high-quality CNG for automotive and industrial use.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-white to-blue-50 p-6 rounded-xl shadow-md border border-blue-100">
                ...
                <p className="mt-2 text-gray-500">
                  Transforming organic waste into valuable products like
                  briquettes, compost, and clean energy.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-white to-green-50 p-6 rounded-xl shadow-md border border-green-100">
                ...
                <p className="mt-2 text-gray-500">
                  Backed by Bhabha Atomic Research Centre's Nisargruna biphasic
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 lg:py-24">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-4 text-lg text-green-100">
              Join us in building a sustainable future with clean energy
              solutions.
            </p>

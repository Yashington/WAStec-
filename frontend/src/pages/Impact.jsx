...
const Impact = () => {
  ...
  const impactStats = [
    ...
    },
    {
      ...
      value: "2,800",
      unit: "tons",
      description: "Organic waste diverted from landfills",
    },
    {
      id: 3,
      name: "Clean Energy",
  ...
  const additionalMetrics = [
    {
      id: 1,
      name: "Households Powered",
      value: "8,500",
      description: "Annual electricity needs met",
    },
    {
      id: 2,
      name: "Vehicles Off Road",
      value: "150",
      description: "Equivalent cars taken off road",
    },
    {
      id: 3,
      name: "Landfill Waste",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500">
              Measuring our contribution to environmental sustainability and
              climate action
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              See how much environmental benefit can be achieved from processing
              your organic waste
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
              <div>
                ...
                <p className="mt-4 text-lg text-gray-600">
                  Enter your daily organic waste generation to see the potential
                  environmental benefits of processing it with our technology.
                </p>
                  ...
                  <div className="mt-6 space-y-4">
                    <div className="flex justify-between items-center pb-3 border-b border-gray-100">
                      ...
                      <span className="font-bold text-green-600">
                        {(impactResults.co2Saved * 365).toLocaleString()} kg
                      </span>
                    </div>
                    <div className="flex justify-between items-center pb-3 border-b border-gray-100">
                      <span className="text-gray-600">Biogas Produced</span>
                      <span className="font-bold text-green-600">
                        {(impactResults.biogasProduced * 365).toLocaleString()}{" "}
                        L
                      </span>
                    </div>
                    <div className="flex justify-between items-center pb-3 border-b border-gray-100">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-green-600">
                        {(impactResults.energyGenerated * 365).toLocaleString()}{" "}
                        kWh
                      </span>
                    </div>
                  </div>
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Cumulative impact of our biogas plants and waste processing
              facilities
            </p>
          </div>
            ...
            {impactStats.map((stat) => (
              ...
              >
                <div className="text-2xl sm:text-3xl font-extrabold text-green-600">
                  {stat.value}
                  {stat.unit && (
                    <span className="text-xl sm:text-2xl"> {stat.unit}</span>
                  )}
                </div>
          ...
          <div className="mt-8 sm:mt-12 grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-4">
            {additionalMetrics.map((metric) => (
              <div
                key={metric.id}
                className="bg-gradient-to-br from-white to-green-50 p-6 rounded-xl shadow-md text-center border border-green-100"
              >
                <div className="text-2xl sm:text-3xl font-extrabold text-green-600">
                  {metric.value}
                  {metric.unit && (
                    <span className="text-xl sm:text-2xl"> {metric.unit}</span>
                  )}
                </div>
                <h3 className="mt-2 text-lg font-medium text-gray-900">
                  {metric.name}
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="lg:text-center">
      ...
      <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
        Tracking our progress in waste management and clean energy
        generation
      </p>
    </div>
    ...
    <div className="mt-12">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        {sdgGoals.map((goal) => (
          ...
          >
            <div
              className={`mx-auto w-12 h-12 sm:w-16 sm:h-16 rounded-full ${goal.color} flex items-center justify-center text-white font-bold text-lg`}
            >
              {goal.goal}
            </div>
            ...
            <p className="mt-2 text-sm text-gray-500">
              Our technology directly supports this global sustainability
              goal through waste reduction and clean energy generation.
            </p>
          </div>
        ))}
      </div>
      ...
      <div className="py-16 bg-gradient-to-r from-green-600 to-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h2 className="text-base font-semibold tracking-wide uppercase text-green-200">
              Climate Action
            </h2>
          ...
          <div className="mt-12 bg-white bg-opacity-10 rounded-xl p-6 sm:p-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
              ...
              <div className="text-center">
                ...
                <div className="mt-4 text-xl sm:text-2xl font-bold text-white">
                  65% Reduction
                </div>
              </div>
